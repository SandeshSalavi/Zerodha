        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                ...
                <div className='col  '>
                    ...
                    <a href='' className='text-muted ' style={{textDecoration:"none"}}>Referal Programme</a><br/><br/>
                ...
                <div className='col'>
                    ...
                    <a href='' className='text-muted ' style={{textDecoration:"none"}}>60 day challenge</a><br/><br/>
                </div>
            </div>
